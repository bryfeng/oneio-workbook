...
<header class="masthead"><div><div class="eyebrow">CLEARER / ONE</div><h1>${document.title}</h1><p class="subtitle">${escape(document.subtitle)}</p></div><div class="edition"><span>Static discussion draft</span><a href="./">API brief ↗</a><a href="system.html">System map ↗</a><a href="flow.html">Flow inside ONE ↗</a><a href="one-api-walkthrough.md" download>Download LLM brief ↓</a></div></header>
