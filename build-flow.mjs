...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Flow inside ONE — Delivery & API</title><meta name="description" content="White-label Fireblocks Flow delivery options, API parameters and checkout sequence for ONE."><style>${baseCss}\n${css}</style></head>
<body><a class="skip-link" href="#delivery">Skip to delivery options</a><main class="flow-document">
<header class="masthead"><div><div class="eyebrow">CLEARER / ONE</div><h1>Flow inside ONE</h1><p class="subtitle">Delivery options and the white-label API</p></div><div class="edition"><span>Working draft · 23 September 2026</span><a href="./">API brief ↗</a><a href="system.html">System map ↗</a><a href="walkthrough.html">API walkthrough ↗</a><a href="flow-experience.html">Collection product spec ↗</a><a href="one-flow-brief.md" download>Download notes ↓</a></div></header>
<nav class="view-tabs" aria-label="Flow document sections"><a href="#delivery" aria-current="location"><span class="nav-number">01</span>Delivery options</a><a href="#flow-api"><span class="nav-number">02</span>Flow API</a><a href="#checkout"><span class="nav-number">03</span>Checkout & receipt</a><a href="#timeline"><span class="nav-number">04</span>Timeline</a></nav>
<section id="delivery" class="flow-section">${heading('01','Delivery options','Proposed')}<div class="flow-intro">${render(intro)}</div><div class="option-head" aria-hidden="true"><span>Delivery option</span><span>Experience at SPARK</span><span>Main dependency</span></div>${options}<p class="reading-hint">Open an option for its build sequence and what follows SPARK</p>${detail('Shared build · White-label checkout',needed(d,'Common build · White-label Flow inside ONE'),'Both options')}</section>
...
<section id="timeline" class="flow-section">${heading('04','Delivery sequence','Working targets')}<div class="flow-prose">${render(needed(d,'Delivery sequence'))}</div></section>
...
<header class="masthead"><div><div class="eyebrow">CLEARER / ONE</div><h1>Collect a payment through ONE</h1><p class="subtitle">One experience, from receiving account to payment receipt</p></div><div class="edition"><span>Product spec draft · 23 September 2026</span><a href="flow.html">Flow delivery & API ↗</a><a href="./">API brief ↗</a><a href="one-flow-experience.md" download>Download product spec ↓</a></div></header>
...
<section id="experience" class="flow-section">${heading('01','The experience','Existing custody first')}<div class="flow-intro">${render(introduction)}</div>${render(body('The experience'))}${detail('What we tested and what remains',body('Scope and evidence'),'Evidence boundary','test-evidence')}</section>
